...
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)   // pour l'inheritance (heritage) c'est mieux d'utiliser single_table meme si des column vont rester null (on peut aussi utiliser table_per_class ou joined_table
